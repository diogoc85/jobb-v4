                ...
                <div className='text-center md:text-left'>
                    ...
                    >
                        <div className="flex flex-col gap-2 items-center md:items-start">
                            <Link className="btn text-3xl w-fit px-8 py-6 gradient hover:gradient" to="https://www.sistemajobb.com.br/teste-gratis" target="_blank">Teste grátis por 15 dias</Link>
